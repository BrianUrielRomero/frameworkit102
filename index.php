...
require_once(APP_PATH."resquest.php");
...
$header = ROOT ."views".DS."layauts".DS."default".DS."header.php";
$fooder = ROOT ."views".DS."layauts".DS."default".DS."fooder.php";
